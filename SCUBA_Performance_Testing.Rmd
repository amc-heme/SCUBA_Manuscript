...
working_dir <- "/mnt/filestore/jairav.desai/SCUBA_Performance_Testing/"
```

<!--This example will use the dataset from [Chan et al. 2021](https://www.cell.com/cancer-cell/fulltext/S1535-6108(21)00497-9#gr1). The dataset can be downloaded [here](https://cellxgene.cziscience.com/collections/62e8f058-9c37-48bc-9200-e767f318a8ec) (download the "Combined samples" dataset). -->
